...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  medicines: { ...entity("medicines"), search: (query, limit, offset) => ipcRenderer.invoke("db:medicines:search", query, limit, offset) },
  sales: entity("sales"),
...
contextBridge.exposeInMainWorld("medicoreServer", {
  ...
  discover: (timeoutMs) => ipcRenderer.invoke("server:discover", timeoutMs),
