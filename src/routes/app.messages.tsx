...
export const Route = createFileRoute("/app/messages")({ component: () => <PermissionGate perm="messages"><MessagesPage /></PermissionGate> });
...
function MessagesPage() {
  ...
  const recipients = user.role === "admin" ? users.filter((u) => u.id !== user.id) : admins;
  ...
  const canSend = user.role === "admin" || user.permissions.messagesToAdmin === true;
