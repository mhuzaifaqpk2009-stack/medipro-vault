...
function MessagesPage() {
  ...
  const canMessageUsers = user.role === "admin" || user.roleTemplate === "manager" || user.permissions.messagesToUsers === true;
