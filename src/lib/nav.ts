...
export const NAV: NavItem[] = [
  ...
  { to: "/app/workflows", label: "Workflow Engine", icon: Workflow, anyPerm: ["sales", "purchases", "stocktake", "operations", "reports"], group: "Inventory" },
