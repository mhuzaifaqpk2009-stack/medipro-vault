...
<style>
  * { box-sizing: border-box; }
  body { font-family: 'Courier New', ui-monospace, monospace; font-size: 12px; color: #000; margin: 0; padding: 12px; width: 300px; }
  h1 { font-size: 15px; text-align: center; margin: 0 0 2px; letter-spacing: .5px; }
  .addr, .meta, .footer { text-align: center; font-size: 11px; line-height: 1.35; }
  ...
  @media print { @page { size: 80mm auto; margin: 4mm; } body { width: auto; padding: 0; } }
</style></head><body>
