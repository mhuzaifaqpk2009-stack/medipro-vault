/** Multi-user accounts + granular permissions. */
...
export interface UserPermissions {
  ...
  suppliersAdd?: boolean; suppliersEdit?: boolean; suppliersDelete?: boolean;
  categoriesAdd?: boolean; categoriesEdit?: boolean; categoriesDelete?: boolean;
  reportsExport?: boolean; reportsPrint?: boolean;
}

export type CounterId = "totalMedicines" | "lowStock" | "expired" | "todayRevenue" | "todayProfit" | "monthRevenue" | "customers" | "suppliers" | "salesTrend" | "mostSold";
export const ALL_COUNTERS: { id: CounterId; label: string }[] = [
  { id: "totalMedicines", label: "Total Medicines" }, { id: "lowStock", label: "Low Stock" }, { id: "expired", label: "Expired" },
  { id: "todayRevenue", label: "Today's Sales" }, { id: "todayProfit", label: "Today's Profit" }, { id: "monthRevenue", label: "Monthly Sales" },
  { id: "customers", label: "Customers" }, { id: "suppliers", label: "Suppliers" }, { id: "salesTrend", label: "Sales trend chart" }, { id: "mostSold", label: "Most sold panel" },
];
...
export interface StoredUser {
  id: string; username: string; role: UserRole; saltHex: string; hashHex: string; permissions: UserPermissions;
...
export function isCounterVisible(u: StoredUser | null, id: CounterId): boolean {
  ...
  return u.dashboardVisibility?.[id] !== false;
}
